...
public  final class ClientPageRespBody extends
        ...
        switch (tag) {
          ...
          case 34: {
            if (!((mutable_bitField0_ & 0x00000008) == 0x00000008)) {
              clients_ = new java.util.ArrayList<org.tio.examples.im.common.packets.Client>();
              mutable_bitField0_ |= 0x00000008;
            }
            clients_.add(
                input.readMessage(org.tio.examples.im.common.packets.Client.parser(), extensionRegistry));
            break;
          }
        }
      }
   ...
   * <code>repeated .Client clients = 4;</code>
   */
  public java.util.List<? extends org.tio.examples.im.common.packets.ClientOrBuilder> 
   ...
   * <code>repeated .Client clients = 4;</code>
   */
  public org.tio.examples.im.common.packets.ClientOrBuilder getClientsOrBuilder(
      int index) {
    return clients_.get(index);
  }
  ...
  public static org.tio.examples.im.common.packets.ClientPageRespBody parseFrom(
  ...
  public static org.tio.examples.im.common.packets.ClientPageRespBody parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static org.tio.examples.im.common.packets.ClientPageRespBody parseFrom(
  ...
  public static org.tio.examples.im.common.packets.ClientPageRespBody parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static org.tio.examples.im.common.packets.ClientPageRespBody parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static org.tio.examples.im.common.packets.ClientPageRespBody parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(org.tio.examples.im.common.packets.ClientPageRespBody other) {
      if (other == org.tio.examples.im.common.packets.ClientPageRespBody.getDefaultInstance()) return this;
    ...
    private void ensureClientsIsMutable() {
      if (!((bitField0_ & 0x00000008) == 0x00000008)) {
        clients_ = new java.util.ArrayList<org.tio.examples.im.common.packets.Client>(clients_);
        bitField0_ |= 0x00000008;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        org.tio.examples.im.common.packets.Client, org.tio.examples.im.common.packets.Client.Builder, org.tio.examples.im.common.packets.ClientOrBuilder> clientsBuilder_;
    ...
    public Builder setClients(
        int index, org.tio.examples.im.common.packets.Client value) {
      if (clientsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setClients(
        int index, org.tio.examples.im.common.packets.Client.Builder builderForValue) {
      if (clientsBuilder_ == null) {
        ensureClientsIsMutable();
    ...
    public Builder addAllClients(
        java.lang.Iterable<? extends org.tio.examples.im.common.packets.Client> values) {
      if (clientsBuilder_ == null) {
        ensureClientsIsMutable();
     ...
     * <code>repeated .Client clients = 4;</code>
     */
    public org.tio.examples.im.common.packets.Client.Builder getClientsBuilder(
        int index) {
    ...
    public org.tio.examples.im.common.packets.Client.Builder addClientsBuilder() {
      return getClientsFieldBuilder().addBuilder(
          org.tio.examples.im.common.packets.Client.getDefaultInstance());
    }
    /**
     * <pre>
     * </pre>
    ...
    public org.tio.examples.im.common.packets.Client.Builder addClientsBuilder(
        int index) {
      return getClientsFieldBuilder().addBuilder(
          index, org.tio.examples.im.common.packets.Client.getDefaultInstance());
    }
    /**
     * <pre>
     * </pre>
     ...
     * <code>repeated .Client clients = 4;</code>
     */
    public java.util.List<org.tio.examples.im.common.packets.Client.Builder> 
